...
>) {
  ...
  // Memoize the directions array to prevent unnecessary recreations
  const directions = useMemo<Direction[]>(
    () => ["TOP", "LEFT", "BOTTOM", "RIGHT"],
    []
  );

  // Now rotateDirection has stable dependencies
  const rotateDirection = useCallback(
    ...
    [clockwise, directions] // directions is now stable
  );
